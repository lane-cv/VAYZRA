	...
	return []retentionArtifactRow{
		{
			...
			RequestedAt: requestedAt, Kind: backup.ArtifactDatabaseDump,
			Repository: repository, ArtifactSnapshotID: snapshotID,
			RunSnapshotID: snapshotID,
		},
		{
			RunID: runID, Trigger: backup.TriggerScheduled, State: state,
			RequestedAt: requestedAt, Kind: backup.ArtifactObjectSnapshot,
			Repository: repository, ArtifactSnapshotID: snapshotID,
			RunSnapshotID: snapshotID,
		},
		{
			RunID: runID, Trigger: backup.TriggerScheduled, State: state,
			RequestedAt: requestedAt, Kind: backup.ArtifactManifest,
			Repository: repository, ArtifactSnapshotID: snapshotID,
			RunSnapshotID: snapshotID,
		},
	}
