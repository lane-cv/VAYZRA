...
<style scoped>
.composer{max-width:780px}.composer>a{color:var(--hl-primary-strong)}.composer form{display:grid;gap:10px}.composer label{display:grid;gap:7px;font-weight:700}.composer input,.composer textarea{box-sizing:border-box;width:100%;padding:11px;border:1px solid var(--hl-border-strong);border-radius:8px;background:var(--hl-surface-solid);color:var(--hl-text);font:inherit}.composer textarea{resize:vertical;line-height:1.6}.composer small{justify-self:end;color:var(--hl-text-muted)}.channel-picker,.subject-picker{display:flex;flex-wrap:wrap;gap:10px;margin:0;padding:0;border:0}.channel-picker legend,.subject-picker legend{width:100%;margin-bottom:6px;font-weight:800}.channel-picker label{display:flex;grid-template-columns:auto 1fr;align-items:flex-start;gap:9px;min-width:220px;padding:14px;border:1px solid var(--hl-border-strong);border-radius:10px}.channel-picker label.selected{border-color:var(--hl-primary);background:var(--hl-primary-soft)}.channel-picker input,.subject-picker input{width:auto}.channel-picker span{display:grid;gap:4px}.channel-picker small{font-weight:400}.subject-picker label{display:flex;grid-template-columns:auto auto;align-items:center}.composer button{justify-self:start;padding:10px 18px;border:0;border-radius:8px;background:var(--hl-primary);color:#fff;font:inherit;font-weight:700}.composer button:disabled{opacity:.6}[role=alert]{color:var(--hl-danger)}
</style>
