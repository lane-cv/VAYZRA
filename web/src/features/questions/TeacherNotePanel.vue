...
<style scoped>.notes{display:grid;gap:12px;padding:16px;border:1px solid #dbe4f0;border-radius:10px;background:#fff}.notes header{display:flex;justify-content:space-between}.notes strong{color:#7a4d00}.notes ul{list-style:none;padding:0}.notes li{padding:8px;border-bottom:1px solid #edf1f5}.notes p{white-space:pre-wrap}.notes time{color:#617086;font-size:.8rem}.notes label,.notes form{display:grid;gap:8px}.notes textarea{min-height:90px}</style>
