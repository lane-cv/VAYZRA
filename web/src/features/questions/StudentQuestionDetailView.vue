...
<style scoped>.detail{display:grid;gap:20px;max-width:900px}.detail>a{color:var(--hl-primary-strong)}.detail>header{display:flex;justify-content:space-between}.detail h1{margin:.2rem 0}.detail header p{color:var(--hl-primary-strong);font-weight:700}.reply{margin-top:8px;padding:20px;border:1px solid var(--hl-border);border-radius:12px;background:var(--hl-surface-solid)}.reply form{display:grid;gap:10px}.reply label{display:grid;gap:7px;font-weight:700}.reply textarea{padding:10px;border:1px solid var(--hl-border-strong);border-radius:8px;background:var(--hl-surface-solid);color:var(--hl-text);font:inherit;line-height:1.6}.reply small{justify-self:end;color:var(--hl-text-muted)}.reply button{justify-self:start;padding:9px 15px}[role=alert]{color:var(--hl-danger)}</style>
