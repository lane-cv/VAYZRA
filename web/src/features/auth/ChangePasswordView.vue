...
<style scoped>
.auth-page{min-height:100vh;display:grid;place-items:center;padding:24px;background:var(--hl-bg);color:var(--hl-text)}.auth-card{width:min(100%,420px);padding:clamp(28px,6vw,48px);border:1px solid var(--hl-border);border-radius:20px;background:var(--hl-surface-solid);box-shadow:var(--hl-shadow)}.eyebrow{margin:0;color:var(--hl-primary-strong);font-size:.86rem;font-weight:700;letter-spacing:.06em}.auth-card h1{margin:10px 0 8px;font-size:clamp(1.8rem,5vw,2.4rem)}.intro{margin:0 0 30px;color:var(--hl-text-muted);line-height:1.65}label{display:block;margin:18px 0 7px;font-weight:650}input{box-sizing:border-box;width:100%;padding:12px 13px;border:1px solid var(--hl-border-strong);border-radius:9px;background:var(--hl-surface-solid);color:var(--hl-text);font:inherit}.primary-button{width:100%;margin-top:24px;padding:13px;border:0;border-radius:9px;background:var(--hl-primary);color:#fff;font:inherit;font-weight:700;cursor:pointer}.primary-button:disabled{opacity:.65;cursor:wait}.text-button{border:0;background:none;padding:0;color:var(--hl-primary-strong);text-decoration:underline;cursor:pointer}.form-message{margin:16px 0 0;color:var(--hl-danger);font-size:.93rem}
</style>
