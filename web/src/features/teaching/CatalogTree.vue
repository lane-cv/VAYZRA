...
<style scoped>
.catalog-tree{display:grid;gap:8px;padding:0;list-style:none}.tree-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;align-items:center;border:1px solid #d8e3ee;border-radius:10px;background:#fff}.node-button{display:flex;gap:10px;align-items:center;min-height:48px;border:0;border-radius:10px;background:transparent;color:#17324d;text-align:left;cursor:pointer}.node-button.selected{outline:2px solid #2d7fbd;background:#eef7fe}.kind{min-width:38px;color:#54718c;font-size:.78rem}.row-actions{display:flex;gap:4px;padding-right:8px}.row-actions button{border:0;background:transparent;color:#37698e;cursor:pointer}@media(max-width:700px){.tree-row{grid-template-columns:1fr}.row-actions{padding:0 10px 10px;justify-content:flex-end}}
</style>
