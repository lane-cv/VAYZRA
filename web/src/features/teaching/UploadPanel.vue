...
<style scoped>
.upload-panel{display:grid;gap:12px;padding:16px;border:1px solid #d7e2ed;border-radius:10px;background:#fff}.upload-panel h2,.upload-panel p{margin:.2rem 0}.upload-panel fieldset{display:flex;gap:18px;border:0;padding:0}.upload-panel fieldset label{display:flex;gap:7px}.file-picker{display:grid;gap:7px}.file-picker input{padding:10px;border:1px dashed #8da9c3;border-radius:8px}.actions,.binding-controls{display:flex;flex-wrap:wrap;align-items:center;gap:8px}.actions button,.binding-controls button{padding:8px 12px;border:1px solid #aac0d4;border-radius:7px;background:#fff}
</style>
