...
<style scoped>
.editor-page{display:grid;gap:20px}.editor-page>a,a{color:#176faf}.page-heading{display:flex;justify-content:space-between;gap:20px;align-items:flex-start}.page-heading h1{margin:.2rem 0}.eyebrow{margin:0;color:#2879b5;font-weight:800}.save-state{color:#567086}.editor-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:24px}.fields,.fields label{display:grid;gap:8px}.fields{align-content:start;gap:16px}.fields input,.fields textarea{box-sizing:border-box;width:100%;padding:10px;border:1px solid #aac0d4;border-radius:7px;font:inherit}.fields textarea{resize:vertical}.primary{border:0;border-radius:8px;padding:10px 16px;background:#176faf;color:#fff;font:inherit;font-weight:700;cursor:pointer}.primary:disabled{opacity:.5;cursor:not-allowed}.notice{padding:14px 16px;border:1px solid #c8d8e7;border-radius:9px;background:#fff}.error{border-color:#e0aaa6;color:#872e29}.dialog-backdrop{position:fixed;z-index:20;inset:0;display:grid;place-items:center;padding:20px;background:#07182888}.dialog-card{width:min(520px,100%);padding:24px;border-radius:12px;background:#fff}.dialog-actions{display:flex;justify-content:flex-end;gap:10px;margin-top:18px}.dialog-actions button{padding:9px 14px;border:1px solid #b9cadb;border-radius:7px;font:inherit}@media(max-width:850px){.editor-grid{grid-template-columns:1fr}.page-heading{display:grid}}
</style>
