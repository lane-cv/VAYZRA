...
<style scoped>.notifications{max-width:820px}.notifications>header{display:flex;align-items:center;justify-content:space-between;gap:20px}.eyebrow{color:#1673b9;font-weight:700}.notifications h1{margin:.35rem 0 1rem}.notifications button{padding:9px 12px;border:1px solid #bdd0e2;border-radius:8px;background:#fff;color:#24506f}.notifications ul{display:grid;gap:10px;padding:0;list-style:none}.notifications li{position:relative;display:flex;align-items:center;gap:10px;border:1px solid #dbe4f0;border-radius:11px;background:#fff}.notifications li.unread{border-left:4px solid #2075bb}.notifications a,.notifications li>div{display:grid;flex:1;gap:6px;padding:16px;color:#182842;text-decoration:none}.notifications span,.notifications time{color:#617086}.notifications time{font-size:.82rem}.notifications li>button{margin-right:14px}.empty{padding:28px;border:1px dashed #bdccdb;border-radius:10px;text-align:center;color:#617086}[role=alert]{color:#a33731}@media(max-width:560px){.notifications>header{align-items:flex-start;flex-direction:column}.notifications li{align-items:stretch;flex-direction:column}.notifications li>button{margin:0 14px 14px}}</style>
