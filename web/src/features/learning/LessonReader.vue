...
<style scoped>
.lesson-reader{min-width:0}.reader-scroll{display:grid;gap:24px;max-height:calc(100vh - 150px);overflow:auto;padding-right:8px}.reader-scroll>header h1{margin:.3rem 0}.eyebrow{color:var(--hl-primary-strong);font-weight:800}.files{display:grid;gap:12px}.file-card{padding:16px;border:1px solid var(--hl-border);border-radius:10px;background:var(--hl-surface-solid)}.file-card h3{margin-top:0}.file-card video{width:100%;max-height:520px;background:#102b4d}.file-actions{display:flex;gap:12px;margin-top:10px}.file-actions a{color:var(--hl-primary-strong)}.notice{padding:24px;border:1px solid #e0aaa6;border-radius:10px;background:var(--hl-danger-soft);color:var(--hl-danger)}@media(max-width:760px){.reader-scroll{max-height:none;overflow:visible}}
</style>
