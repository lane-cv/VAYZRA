...
<style scoped>
.learning{display:grid;gap:20px}.learning header h1{margin:.25rem 0}.eyebrow{margin:0;color:#2879b5;font-weight:800}.filters{display:grid;grid-template-columns:repeat(3,minmax(120px,1fr)) minmax(220px,2fr);gap:12px}.filters label,.course-nav label{display:grid;gap:6px}.filters select,.filters input,.course-nav select{padding:9px;border:1px solid #aac0d4;border-radius:7px;font:inherit}.workspace{display:grid;grid-template-columns:260px minmax(0,1fr);gap:22px}.course-nav{padding:16px;border:1px solid #d7e2ed;border-radius:10px;background:#fff}.course-nav ul{display:grid;gap:6px;padding:0;list-style:none}.course-nav a,.search-results a{color:#176faf;text-decoration:none}.reader-empty,.empty{padding:28px;border:1px dashed #b9cadb;border-radius:10px;background:#fff;text-align:center}.search-results{display:grid;gap:8px}.search-results a{display:grid;gap:4px;padding:12px;border:1px solid #d7e2ed;border-radius:8px;background:#fff}.search-results span{color:#52677b}.course-menu,.course-close,.course-scrim{display:none}@media(max-width:850px){.filters{grid-template-columns:1fr 1fr}.workspace{grid-template-columns:1fr}.course-menu{display:block;justify-self:start;padding:9px 13px;border:1px solid #aac0d4;border-radius:7px;background:#fff}.course-nav{position:fixed;z-index:31;inset:0 auto 0 0;width:min(320px,85vw);transform:translateX(-105%);transition:transform .2s}.course-nav.open{transform:none}.course-close{display:block;margin-left:auto}.course-scrim{display:block;position:fixed;z-index:30;inset:0;border:0;background:#07182888}}@media(max-width:560px){.filters{grid-template-columns:1fr}}@media(prefers-reduced-motion:reduce){.course-nav{transition:none}}
</style>
