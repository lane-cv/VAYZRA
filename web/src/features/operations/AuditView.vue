      ...
      <fieldset>
        ...
        <label for="audit-outcome">结果
          <select id="audit-outcome" v-model="filters.outcome" data-testid="audit-outcome">
            ...
            <option value="attempted">已发起</option>
          </select>
        </label>
...
<style scoped>
.page{max-width:1120px}.page-heading{margin-bottom:22px}.page-heading h1{margin:.35rem 0;font-size:clamp(1.75rem,4vw,2.55rem)}.page-heading p:not(.eyebrow){color:var(--hl-text-muted)}.page-heading a{color:var(--hl-primary-strong);font-weight:700}.eyebrow{margin:0;color:var(--hl-primary-strong);font-size:.84rem;font-weight:700;letter-spacing:.06em}.filters fieldset{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin:0;padding:20px;border:1px solid var(--hl-border);border-radius:14px;background:var(--hl-surface-solid)}.filters legend{padding:0 7px;color:var(--hl-text);font-weight:800}.filters label{display:grid;gap:7px;color:var(--hl-text-muted);font-weight:700}.filters input,.filters select{box-sizing:border-box;width:100%;border:1px solid var(--hl-border-strong);border-radius:8px;background:var(--hl-surface-solid);color:var(--hl-text);padding:10px 11px;font:inherit}.filters button,.load-more,.feedback button{align-self:end;border:0;border-radius:8px;background:var(--hl-primary);color:#fff;padding:11px 15px;font:inherit;font-weight:700;cursor:pointer}.filters button:disabled,.load-more:disabled,.feedback button:disabled{opacity:.55;cursor:not-allowed}.results{margin-top:26px}.results h2{outline:none}.results ol{display:grid;gap:14px;margin:0;padding:0;list-style:none}.results article{padding:18px 20px;border:1px solid var(--hl-border);border-radius:13px;background:var(--hl-surface-solid)}.results article header{display:flex;align-items:start;justify-content:space-between;gap:18px}.results article header div{display:grid;gap:5px}.results article header strong{overflow-wrap:anywhere;color:var(--hl-text)}.results article header span,.results time{color:var(--hl-text-muted);font-size:.9rem}.results dl{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px 20px;margin:16px 0 0}.results dl div{display:grid;grid-template-columns:max-content minmax(0,1fr);gap:8px}.results dt{color:var(--hl-text-muted)}.results dd{margin:0;overflow-wrap:anywhere;color:var(--hl-text)}.feedback{margin:18px 0;padding:14px 16px;border:1px solid #efb3ae;border-radius:10px;background:#fff5f4;color:#862b25}.feedback p{margin:0 0 9px}.load-more{margin-top:18px}.denied{max-width:650px;padding:32px;border:1px solid #efc1be;border-radius:13px;background:var(--hl-surface-solid)}@media(max-width:760px){.filters fieldset{grid-template-columns:1fr}.filters button{width:100%}.results article header{align-items:stretch;flex-direction:column}.results dl{grid-template-columns:1fr}.load-more{width:100%}}
</style>
