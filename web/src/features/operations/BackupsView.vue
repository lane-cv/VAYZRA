...
<style scoped>
.page{max-width:1120px}.page-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:24px;margin-bottom:28px}.eyebrow{margin:0;color:var(--hl-primary-strong);font-weight:800;letter-spacing:.06em}.page-heading h1{margin:.45rem 0;font-size:clamp(1.8rem,4vw,2.7rem)}.page-heading p{color:var(--hl-text-muted)}.primary,.backup-card button,.load-more,.dialog button{border:1px solid var(--hl-border-strong);border-radius:9px;background:var(--hl-surface-solid);color:var(--hl-text);padding:10px 14px;font:inherit;font-weight:700;cursor:pointer}.primary{border-color:var(--hl-primary);background:var(--hl-primary);color:#fff}.primary:disabled,.backup-card button:disabled,.load-more:disabled,.dialog button:disabled{cursor:wait;opacity:.65}.backup-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.backup-card{padding:22px;border:1px solid var(--hl-border);border-radius:14px;background:var(--hl-surface-solid);box-shadow:var(--hl-shadow-soft)}.backup-card.state-degraded{border-color:#efc16e}.backup-card.state-failed{border-color:#e3aaa5}.card-top{display:flex;align-items:flex-start;justify-content:space-between;gap:16px}.trigger{color:var(--hl-text-muted);font-size:.85rem}.card-top h2{margin:.35rem 0;font-size:1.25rem}.state-pill{border-radius:999px;background:var(--hl-primary-soft);color:var(--hl-primary-strong);padding:5px 9px;font-size:.78rem;font-weight:800}.state-degraded .state-pill{background:#fff2d6;color:#8a5b00}.state-failed .state-pill{background:#fde9e7;color:#a23c35}.warning{padding:10px 12px;border-radius:9px;background:#fff8e8;color:#78530d;line-height:1.55}.backup-card dl{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin:18px 0}.backup-card dl div{min-width:0}.backup-card dt{color:var(--hl-text-muted);font-size:.78rem}.backup-card dd{margin:4px 0 0;color:var(--hl-text);font-weight:700}.feedback{margin:16px 0;padding:14px;border-radius:10px}.feedback.error{background:#fff0ef;color:#8e302b}.feedback.success{background:#eaf8ef;color:#176b37}.empty,.detail{margin-top:18px;padding:28px;border:1px solid var(--hl-border);border-radius:14px;background:var(--hl-surface-solid)}.load-more{display:block;margin:22px auto}.artifact-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.artifact-grid article,.restore-result{padding:16px;border-radius:11px;background:var(--hl-surface-muted)}.artifact-grid span{display:block;color:var(--hl-text-muted);font-size:.78rem}.artifact-grid strong{display:block;margin:5px 0}.artifact-grid p,.restore-result p{color:var(--hl-text-muted)}.restore-result{margin-top:14px}.restore-result h3{margin-top:0}.dialog{width:min(480px,calc(100% - 36px));padding:24px;border:0;border-radius:14px;background:var(--hl-surface-solid);color:var(--hl-text);box-shadow:var(--hl-shadow)}.dialog::backdrop{background:#0b223a99}.dialog h2{margin-top:0}.dialog p{color:var(--hl-text-muted);line-height:1.6}.dialog-actions{display:flex;justify-content:flex-end;gap:10px;margin-top:22px}.denied{max-width:680px}@media(max-width:760px){.page-heading{align-items:stretch;flex-direction:column}.backup-grid,.artifact-grid{grid-template-columns:1fr}.backup-card dl{grid-template-columns:1fr 1fr}.page-heading .primary{width:100%}}@media(max-width:420px){.backup-card dl{grid-template-columns:1fr}.dialog-actions{align-items:stretch;flex-direction:column-reverse}.dialog-actions button{width:100%}}
</style>
