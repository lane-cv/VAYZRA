...
<style scoped>
.home{max-width:1180px;margin:0 auto}.page-heading,.panel header{display:flex;align-items:flex-start;justify-content:space-between;gap:20px}.eyebrow,.kicker{margin:0;color:var(--hl-primary-strong);font-size:.78rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.home h1{margin:.45rem 0;font-size:clamp(2rem,4vw,3rem)}.lead,.observed,.panel p,.summaries p{color:var(--hl-text-muted)}.observed{max-width:260px;text-align:right}.feedback{margin:20px 0;padding:16px;border-radius:12px}.feedback.error{border:1px solid #e4b7b3;background:#fff5f4;color:#8d2e29}.feedback button,.panel a{border:0;border-radius:8px;background:var(--hl-primary);color:#fff;padding:8px 12px;font:inherit;font-weight:700;text-decoration:none;cursor:pointer}.dashboard-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px;margin-top:28px}.panel,.summaries article{border:1px solid var(--hl-border);border-radius:16px;background:var(--hl-surface-solid);box-shadow:var(--hl-shadow-soft)}.panel{padding:22px}.panel h2{margin:5px 0 0}.alerts,.backup,.summaries,.audit{grid-column:1/-1}.alert-counts{display:flex;gap:14px;margin:24px 0}.alert-counts>div{display:flex;align-items:baseline;gap:8px;min-width:140px;padding:18px;border-radius:12px}.alert-counts strong{font-size:2.1rem}.critical{background:#fff0ef;color:#a22b25}.warning-count{background:#fff7e8;color:#8a5910}.state-line{font-weight:700}.recovery-points,.summaries{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin-top:20px}.recovery-points article{display:grid;gap:7px;padding:16px;border-radius:12px;background:var(--hl-surface-muted)}.recovery-points time,.recovery-points small{color:var(--hl-text-muted)}.health-list,.audit ol{display:grid;gap:10px;margin:18px 0 0;padding:0;list-style:none}.health-list li,.audit li{padding:14px;border-radius:10px;background:var(--hl-surface-muted)}.health-list li>div,.audit li{display:flex;justify-content:space-between;gap:16px}.health-list p{margin:6px 0 0;font-size:.86rem}.summaries{grid-template-columns:repeat(4,minmax(0,1fr));margin-top:0}.summaries article{padding:20px}.summaries span,.summaries p{color:var(--hl-text-muted)}.summaries strong{display:block;margin:8px 0;color:var(--hl-text);font-size:1.8rem}.summaries small{font-weight:700}.good{color:#167248}.warning{color:#8a5910}.danger{color:#a22b25}.unknown{color:var(--hl-text-muted)}.audit li time{color:var(--hl-text-muted)}.audit>p{margin-bottom:0}@media(min-width:801px){.summaries{order:-1}}@media(max-width:800px){.dashboard-grid{grid-template-columns:1fr}.alerts,.backup,.summaries,.audit{grid-column:auto}.summaries,.recovery-points{grid-template-columns:1fr}.page-heading,.panel header{align-items:flex-start;flex-direction:column}.observed{text-align:left}.alert-counts{flex-direction:column}.alert-counts>div{box-sizing:border-box;width:100%}.audit li{align-items:flex-start;flex-direction:column}}@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto}}
</style>
