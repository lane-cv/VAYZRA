...
<style scoped>
.page{max-width:1180px}.page-heading{margin-bottom:24px}.page-heading h1{margin:.35rem 0;font-size:clamp(1.75rem,4vw,2.55rem)}.page-heading p:not(.eyebrow){margin:0;color:#5b6b80}.eyebrow{margin:0;color:#1673b9;font-size:.84rem;font-weight:700;letter-spacing:.06em}.tabs{display:flex;gap:6px;overflow-x:auto;margin-bottom:22px;padding:5px;border:1px solid #dbe4f0;border-radius:11px;background:#fff}.tabs button{flex:0 0 auto;border:0;border-radius:8px;background:transparent;color:#496077;padding:10px 14px;font:inherit;font-weight:700;cursor:pointer}.tabs button[aria-selected=true]{background:#166cbb;color:#fff}.denied{max-width:650px;padding:32px;border:1px solid #efc1be;border-radius:13px;background:#fff}
</style>
