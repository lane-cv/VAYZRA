...
<style scoped>
.editor{display:grid;gap:16px}.editor h2{margin:0}.provider-select{display:grid;gap:6px;max-width:360px;font-weight:650}.provider-select select,fieldset input{padding:9px;border:1px solid var(--hl-border-strong);border-radius:8px;background:var(--hl-surface-solid);color:var(--hl-text);font:inherit}.route-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}fieldset{display:grid;gap:12px;padding:18px;border:1px solid var(--hl-border);border-radius:12px;background:var(--hl-surface-solid)}legend{padding:0 6px;font-weight:800}fieldset label:not(.check){display:grid;gap:5px;font-weight:650}.check{display:flex;gap:8px;align-items:center}button{justify-self:start;border:1px solid var(--hl-primary);border-radius:8px;background:var(--hl-primary);color:#fff;padding:9px 12px;font:inherit;font-weight:650}@media(max-width:800px){.route-grid{grid-template-columns:1fr}}
</style>
