...
<style scoped>
.editor{display:grid;gap:16px}.editor h2,.editor h3{margin:0}.editor>p{color:#5b6b80}.limit-card,.student-picker{display:grid;gap:14px;padding:18px;border:1px solid #dbe4f0;border-radius:12px;background:#fff}.limit-row{display:grid;grid-template-columns:minmax(180px,1fr) minmax(180px,1fr);gap:12px}.limit-row label,.student-picker label{display:grid;gap:6px;font-weight:650}.limit-row select,.limit-row input,.student-picker input{padding:9px;border:1px solid #b9c9da;border-radius:8px;font:inherit}.student-results{display:flex;flex-wrap:wrap;gap:8px}.student-results button[aria-pressed=true]{border-color:#166cbb;background:#e7f3fc}.limit-card>button{justify-self:start;border-color:#166cbb;background:#166cbb;color:#fff}button{border:1px solid #b8cce0;border-radius:8px;background:#fff;color:#244563;padding:9px 12px;font:inherit;font-weight:650;cursor:pointer}@media(max-width:640px){.limit-row{grid-template-columns:1fr}}
</style>
