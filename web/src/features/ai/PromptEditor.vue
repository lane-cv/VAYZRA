...
<style scoped>
.editor{display:grid;gap:12px}.editor h2{margin:0}.editor>p{color:#5b6b80}.prompt-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.prompt-grid form{display:grid;gap:10px;padding:18px;border:1px solid #dbe4f0;border-radius:12px;background:#fff}.prompt-grid h3{margin:0}.prompt-grid label{font-weight:650}.prompt-grid textarea{resize:vertical;padding:11px;border:1px solid #b9c9da;border-radius:8px;font:inherit;line-height:1.6}.prompt-grid button{justify-self:start;border:1px solid #166cbb;border-radius:8px;background:#166cbb;color:#fff;padding:9px 12px;font:inherit;font-weight:650}@media(max-width:800px){.prompt-grid{grid-template-columns:1fr}}
</style>
