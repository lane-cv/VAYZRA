...
<style scoped>
.page{max-width:1280px}.page-heading{margin-bottom:22px}.page-heading h1{margin:.35rem 0;font-size:clamp(1.75rem,4vw,2.55rem)}.page-heading p:not(.eyebrow){margin:0;color:#5b6b80}.eyebrow{margin:0;color:#1673b9;font-size:.84rem;font-weight:700;letter-spacing:.06em}.filters{display:grid;grid-template-columns:repeat(5,minmax(145px,1fr));gap:12px;padding:16px;border:1px solid #dbe4f0;border-radius:12px;background:#fff}.filters label{display:grid;gap:6px;color:#496077;font-size:.84rem;font-weight:700}.filters input,.filters select{box-sizing:border-box;width:100%;min-height:40px;border:1px solid #b8c9da;border-radius:8px;background:#fff;color:#183b5d;padding:7px 9px;font:inherit}h2:focus{outline:3px solid #77baf0;outline-offset:4px}.state,.error-state{padding:24px;border:1px solid #dbe4f0;border-radius:12px;background:#fff}.error-state{border-color:#e4b7b3;color:#8b302c}.error-state button,.load-more button{border:1px solid #1772b7;border-radius:8px;background:#1772b7;color:#fff;padding:9px 14px;font:inherit;font-weight:700;cursor:pointer}.append-error{margin-top:16px}.load-more{display:flex;justify-content:center;margin-top:18px}.denied{max-width:650px;padding:32px;border:1px solid #efc1be;border-radius:13px;background:#fff}@media(max-width:899px){.filters{grid-template-columns:1fr 1fr}}@media(max-width:560px){.filters{grid-template-columns:1fr}}@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto!important;transition:none!important;animation:none!important}}
</style>
