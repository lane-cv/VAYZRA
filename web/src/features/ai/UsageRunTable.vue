...
<style scoped>
.desktop-table{overflow-x:auto;border:1px solid var(--hl-border);border-radius:12px;background:var(--hl-surface-solid)}table{width:100%;border-collapse:collapse;min-width:1050px}th,td{padding:12px;text-align:left;vertical-align:top;border-bottom:1px solid var(--hl-border);font-size:.86rem}th{color:var(--hl-text-muted);background:var(--hl-surface-muted);white-space:nowrap}tbody tr:last-child td{border-bottom:0}code{overflow-wrap:anywhere;font-size:.78rem}.status{font-weight:700}.status[data-status=succeeded]{color:#237344}.status[data-status=failed],.status[data-status=cancelled]{color:#a3473d}.mobile-cards{display:grid;gap:12px}.mobile-run-card{padding:16px;border:1px solid var(--hl-border);border-radius:12px;background:var(--hl-surface-solid)}.mobile-run-card h3{margin:0 0 12px;font-size:1rem}.mobile-run-card dl{display:grid;gap:8px;margin:0}.mobile-run-card dl div{display:grid;grid-template-columns:7rem 1fr;gap:8px}.mobile-run-card dt{color:var(--hl-text-muted)}.mobile-run-card dd{min-width:0;margin:0;overflow-wrap:anywhere}@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto!important;transition:none!important;animation:none!important}}
</style>
