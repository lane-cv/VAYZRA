...
<style scoped>
.files-page{display:grid;gap:22px;color:var(--hl-text)}.eyebrow{margin:0;color:var(--hl-primary-strong);font-weight:800}h1{margin:.2rem 0}.filters{display:grid;grid-template-columns:2fr repeat(3,1fr) auto;gap:12px;align-items:end;padding:18px;border:1px solid var(--hl-border);border-radius:12px;background:var(--hl-surface-solid)}.filters label{display:grid;gap:6px;color:var(--hl-text-muted);font-size:.85rem}.filters input,.filters select{min-width:0;padding:9px;border:1px solid var(--hl-border-strong);border-radius:7px;background:var(--hl-surface-solid);color:var(--hl-text);font:inherit}.filters button,.actions button,.pagination button,.detail button,.backdrop button{padding:8px 11px;border:1px solid var(--hl-border-strong);border-radius:7px;background:var(--hl-surface-solid);color:var(--hl-text);font:inherit;cursor:pointer}.table-wrap{overflow:auto;border:1px solid var(--hl-border);border-radius:12px;background:var(--hl-surface-solid)}table{width:100%;border-collapse:collapse}th,td{padding:14px;text-align:left;border-bottom:1px solid var(--hl-border);vertical-align:top}small{display:block;margin-top:4px;color:var(--hl-text-muted)}.actions{display:flex;flex-wrap:wrap;gap:6px}.danger{color:#a23731!important;border-color:#dfb3b0!important}.state{font-weight:700}.pagination{display:flex;justify-content:flex-end;gap:8px}.notice{padding:26px;border:1px dashed var(--hl-border-strong);border-radius:12px;background:var(--hl-surface-solid);text-align:center}.error{border-style:solid;border-color:#e0aaa6;color:#872e29}.detail{position:fixed;z-index:10;top:80px;right:20px;bottom:20px;width:min(430px,calc(100vw - 40px));overflow:auto;padding:24px;border:1px solid var(--hl-border);border-radius:14px;background:var(--hl-surface-solid);box-shadow:var(--hl-shadow)}.detail .close{float:right}.backdrop{position:fixed;z-index:20;inset:0;display:grid;place-items:center;padding:20px;background:#07182888}.backdrop section{width:min(460px,100%);padding:24px;border-radius:12px;background:var(--hl-surface-solid)}.backdrop section>div{display:flex;justify-content:flex-end;gap:9px;margin-top:20px}.backdrop label{display:grid;gap:7px}.backdrop input{padding:9px;border:1px solid var(--hl-border-strong);border-radius:7px;background:var(--hl-surface-solid);color:var(--hl-text)}@media(max-width:850px){.filters{grid-template-columns:1fr 1fr}.table-wrap table{min-width:780px}}@media(max-width:560px){.filters{grid-template-columns:1fr}}
</style>
